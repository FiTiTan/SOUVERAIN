...
import { VaultFilterDropdown } from './VaultFilterDropdown';
...
export const VaultModule: React.FC = () => {
  ...
  console.log('[VaultModule] showImportModal:', showImportModal);
  ...
  if (!loading && documents.length === 0 && selectedCategory === 'all' && !searchQuery) {
    return (
      <>
      ...
      <div style={styles.header}>
        ...
        <div style={styles.headerRight}>
          ...
          <button
            ...
            onClick={() => {
              console.log('[VaultModule] Add button clicked');
              setShowImportModal(true);
              console.log('[VaultModule] showImportModal set to true');
            }}
            onMouseEnter={(e) => {
