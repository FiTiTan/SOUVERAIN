...
export const LoaderIcon: React.FC<IconProps> = ({ size, color, strokeWidth } = defaultProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const CheckCircleIcon: React.FC<IconProps> = ({ size, color, strokeWidth } = defaultProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const CircleIcon: React.FC<IconProps> = ({ size, color, strokeWidth } = defaultProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ShieldIcon: React.FC<IconProps> = ({ size, color, strokeWidth } = defaultProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SparklesIcon: React.FC<IconProps> = ({ size, color, strokeWidth } = defaultProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const LayoutIcon: React.FC<IconProps> = ({ size, color, strokeWidth } = defaultProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
