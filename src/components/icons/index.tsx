/**
 * SOUVERAIN - Global Icon Library
 * SVG icons replacing all emojis (CALM-UI compliance)
 */
...
// Business
export const ShoppingBagIcon: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
