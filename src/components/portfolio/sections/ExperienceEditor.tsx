...
import type { ExperienceContent, ExperienceEntry } from '../../../types/portfolio';
...
export const ExperienceEditor: React.FC<ExperienceEditorProps> = ({ content, onChange }) => {
  ...
  const handleEditEntry = (entry: ExperienceEntry, index: number) => {
          ...
          content.entries.map((entry, index) => (
            <div key={entry.id} style={styles.entryCard}>
              <div style={styles.entryInfo}>
                <div style={styles.entryPosition}>{entry.position || 'Poste non renseigné'}</div>
                <div style={styles.entryCompany}>{entry.company || 'Entreprise non renseignée'}</div>
          ...
          <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
            <div style={styles.modalHeader}>
              <h2 style={styles.modalTitle}>
                {editingIndex !== null ? 'Modifier l\'expérience' : 'Ajouter une expérience'}
              </h2>
              <button
                style={styles.iconButton}
            ...
            <div style={styles.modalBody}>
              <div style={styles.field}>
                ...
                <input
                  ...
                  onChange={(e) => setEditingEntry({ ...editingEntry, position: e.target.value })}
              ...
              <label style={styles.checkbox}>
                <input
                  ...
                  onChange={(e) =>
                    setEditingEntry({ ...editingEntry, isCurrent: e.target.checked, endDate: e.target.checked ? '' : editingEntry.endDate })
                  }
                  style={{ cursor: 'pointer' }}
                />
                <span style={styles.label}>Poste actuel</span>
              </label>
              ...
              <div style={styles.field}>
                <label style={styles.label}>Réalisations clés</label>
                <div style={styles.achievementsList}>
                  {editingEntry.achievements.map((achievement, idx) => (
                    <div key={idx} style={styles.achievementItem}>
                      ...
                      <button
                        style={{ ...styles.iconButton, width: '24px', height: '24px', fontSize: typography.fontSize.sm }}
