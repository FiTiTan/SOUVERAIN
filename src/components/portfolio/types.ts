...
export interface Realisation {
  ...
  extractedContent?: string;  // Contenu complet extrait (PDF, Notion, etc.) pour l'IA
}
...
export interface PortfolioFormDataV2 {
  ...
  // Step 2 : Réalisations + Positionnement (plus de step Expertise - services générés auto par DeepSeek)
